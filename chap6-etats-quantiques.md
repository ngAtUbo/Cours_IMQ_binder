...
Nous pouvons faire l\'analogie avec l\'espace ordinaire *R^3^*. La
...
à son adjoint : $\widehat{A} = \widehat{A}^†$

### Opérateur unitaire

Un opérateur est dit unitaire si :
$$\widehat{U}^†= \widehat{U}^†\widehat{U} = \widehat{1}$$
...
$\overrightarrow{A}$ de l\'espace ordinaire (R^3^). Si
